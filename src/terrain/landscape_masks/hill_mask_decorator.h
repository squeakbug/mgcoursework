#ifndef HILL_MASK_DECORATOR_H
#define HILL_MASK_DECORATOR_H
...
class HillMaskDecorator : public ILandscapeMask
{
public:
    HillMaskDecorator(std::shared_ptr<ILandscapeMask> wrappee);
